...
from ..opencv_info import USE_OPENCV2
from .. import misc
from ..fileio import check_file_exist, mkdir_or_exist
...
def imread(img_or_path, flag='color'):
    ...
    if isinstance(img_or_path, np.ndarray):
        return img_or_path
    elif misc.is_str(img_or_path):
        flag = imread_flags[flag] if misc.is_str(flag) else flag
